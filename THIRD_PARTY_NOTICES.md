...
A interface da versão 1.3.0 utiliza pywebview sob a licença BSD de 3 cláusulas. A biblioteca hospeda o dashboard HTML/CSS na janela nativa do Windows por meio do WebView2. O texto acompanha o pacote em `licenses/pywebview-LICENSE.txt`.
